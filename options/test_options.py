...
class TestOptions:
	...
	def initialize(self):
		...
		# added by Alvin:
		# for controlling whether to generate image separately:
		self.parser.add_argument('--separate_n_images', type=bool, default=False, help='Whether to separate the images to be generated.')
		...
		# added by Alvin:
		self.parser.add_argument('--learning_rate', type=float, default=None, help='used for the fine tunning super resolution results.')
		self.parser.add_argument('--n_epoch', type=int, default=None, help='used for the fine tunning super resolution results.')
