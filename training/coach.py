# edited by Alvin: changed cuda to 1. May need to change it back to 0
	...
	def train(self):
		...
		while self.global_step < self.opts.max_steps:
			for batch_idx, batch in enumerate(self.train_dataloader):
				# crossing correct input/target
				# if batch_idx == 0:
				# 	first_image_source, first_image_target = batch[0][0]
				# 	common.tensor2im(first_image_source).view()
